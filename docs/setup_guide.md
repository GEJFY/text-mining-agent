...
1. ダッシュボード（`http://localhost:5173/` または `http://localhost:3000/`）にアクセスして、UIを確認
2. 「データインポート」ページからサンプルのCSVファイルをアップロード
3. クラスタリング分析やセンチメント分析を実行して、基本的な機能を確認
4. APIドキュメント（`http://localhost:8000/docs`）で利用可能なエンドポイントを確認
